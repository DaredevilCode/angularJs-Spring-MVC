...
import br.com.curso.listener.ContextLoaderListenerUtils;

/**
 * Intercepta todas as requisicoes, faz commit e rollback 
 * @author DareDevilCoder
 */
@WebFilter(filterName="conexaoFilter")
public class FilterOpenSessionInView extends DelegatingFilterProxy 
	...
	public void doFilter(ServletRequest servletRequest,
		...
		throws IOException, ServletException {
			BasicDataSource springDataSource = (BasicDataSource) ContextLoaderListenerUtils
